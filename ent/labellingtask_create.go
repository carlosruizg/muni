...
func (ltc *LabellingTaskCreate) SetName(s string) *LabellingTaskCreate {
...
func (ltc *LabellingTaskCreate) SetInstructions(s string) *LabellingTaskCreate {
	ltc.mutation.SetInstructions(s)
	return ltc
}
...
func (ltc *LabellingTaskCreate) check() error {
	if _, ok := ltc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "LabellingTask.name"`)}
	}
	...
	if _, ok := ltc.mutation.Instructions(); !ok {
		return &ValidationError{Name: "instructions", err: errors.New(`ent: missing required field "LabellingTask.instructions"`)}
	}
	return nil
}
...
func (ltc *LabellingTaskCreate) createSpec() (*LabellingTask, *sqlgraph.CreateSpec) {
	...
	if value, ok := ltc.mutation.Instructions(); ok {
