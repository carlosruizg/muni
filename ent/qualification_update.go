...
func (qu *QualificationUpdate) AddTaskIDs(ids ...int) *QualificationUpdate {
	qu.mutation.AddTaskIDs(ids...)
	return qu
}

// AddTasks adds the "tasks" edges to the LabellingTask entity.
func (qu *QualificationUpdate) AddTasks(l ...*LabellingTask) *QualificationUpdate {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// ClearTasks clears all "tasks" edges to the LabellingTask entity.
func (qu *QualificationUpdate) ClearTasks() *QualificationUpdate {
	qu.mutation.ClearTasks()
	return qu
}

// RemoveTaskIDs removes the "tasks" edge to LabellingTask entities by IDs.
func (qu *QualificationUpdate) RemoveTaskIDs(ids ...int) *QualificationUpdate {
	qu.mutation.RemoveTaskIDs(ids...)
	return qu
}

// RemoveTasks removes "tasks" edges to LabellingTask entities.
func (qu *QualificationUpdate) RemoveTasks(l ...*LabellingTask) *QualificationUpdate {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// AddTaskIDs adds the "tasks" edge to the LabellingTask entity by IDs.
func (quo *QualificationUpdateOne) AddTaskIDs(ids ...int) *QualificationUpdateOne {
	quo.mutation.AddTaskIDs(ids...)
	return quo
}

// AddTasks adds the "tasks" edges to the LabellingTask entity.
func (quo *QualificationUpdateOne) AddTasks(l ...*LabellingTask) *QualificationUpdateOne {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
...
// ClearTasks clears all "tasks" edges to the LabellingTask entity.
func (quo *QualificationUpdateOne) ClearTasks() *QualificationUpdateOne {
	quo.mutation.ClearTasks()
	return quo
}

// RemoveTaskIDs removes the "tasks" edge to LabellingTask entities by IDs.
func (quo *QualificationUpdateOne) RemoveTaskIDs(ids ...int) *QualificationUpdateOne {
	quo.mutation.RemoveTaskIDs(ids...)
	return quo
}

// RemoveTasks removes "tasks" edges to LabellingTask entities.
func (quo *QualificationUpdateOne) RemoveTasks(l ...*LabellingTask) *QualificationUpdateOne {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
