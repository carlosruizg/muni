...
type QualificationEdges struct {
	...
	Tasks []*LabellingTask `json:"tasks,omitempty"`
	...
	namedTasks   map[string][]*LabellingTask
	namedExperts map[string][]*Expert
}

// TasksOrErr returns the Tasks value or an error if the edge
// was not loaded in eager-loading.
func (e QualificationEdges) TasksOrErr() ([]*LabellingTask, error) {
	if e.loadedTypes[0] {
		return e.Tasks, nil
	}
...
// QueryTasks queries the "tasks" edge of the Qualification entity.
func (q *Qualification) QueryTasks() *LabellingTaskQuery {
	return NewQualificationClient(q.config).QueryTasks(q)
}
...
func (q *Qualification) NamedTasks(name string) ([]*LabellingTask, error) {
...
func (q *Qualification) appendNamedTasks(name string, edges ...*LabellingTask) {
	if q.Edges.namedTasks == nil {
		q.Edges.namedTasks = make(map[string][]*LabellingTask)
	}
	if len(edges) == 0 {
		q.Edges.namedTasks[name] = []*LabellingTask{}
	} else {
